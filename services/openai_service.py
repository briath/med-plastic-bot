...
class FallbackService:
    ...
    def __init__(self):
        self.faq_responses = {
            ...
            "риск": [
                "Как у любой операции, риски есть, но минимальны - около 1-2%. Используем современное оборудование и опытные хирурги.",
            ...
            "консультация": [
                "Консультация у нас бесплатная, врач все покажет и расскажет. Записаться можно по телефону или в Telegram.",
                "Да, первичная консультация бесплатная. Длится около часа, можно задать все вопросы врачу.",
                "Консультация ни к чему не обязывает. Врач осмотрит, посоветует варианты, рассчитает стоимость."
            ]
        }
